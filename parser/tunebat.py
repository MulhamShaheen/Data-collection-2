...
with open('E:/AI Talent Hub/Data Collection/Module 2/parser/token.json', 'r') as fp:
    data = json.load(fp)
...
def search_tracks(term, page):
    ...
    # proxies = get_scrapeops_url(url)
    response = requests.get(url_scrapeops, verify=False)
